...
from tests.examples.sample_1.schema import ContactsSchema
from tests.examples.sample_1.validator import CustomValidator
...
def main():
    ...
    filepath = os.path.join(os.getcwd(), 'input', 'tbl_account_golden_gate_12020202020202.csv')
    extn = 'csv'
