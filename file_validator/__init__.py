...
class Reporter(object):
    def report(self, result, logs, reords_count, **kwargs):
        report = Report()
        report.report(schema=result, logs=logs, records_count=reords_count, **kwargs)
...
def main():
    ...
    session = Session()
    filepath = '/Users/sujavarghese/projects/sample_files/input.csv'
    extn = 'csv'
    schema_type = "KTAS-VEHICLE"
    schema_path = "/Users/sujavarghese/projects/file-validator/tests/fixtures/test_schema.json"
    report_path = "/Users/sujavarghese/projects/sample_files"
    report_name = "validation-report.xlsx"
    summary_name = "Summary Report"
    detailed_name = "Detailed Report"
